...
export const frontmatter = {
  ...
  color: "blue",
  description:
    "A custom page with the collection of all properties listed, with clickable filter buttons. Also included is a modified search bar that searches by post title and category. Created with PHP for the filter and CSS for the page design.",
